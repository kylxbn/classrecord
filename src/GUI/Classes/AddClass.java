...
public class AddClass extends javax.swing.JFrame {
     ...
     */
    public AddClass(int i, int c, Classes se) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(cboLevel, 0, 247, Short.MAX_VALUE)
    ...
    private void cmdSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSaveActionPerformed
        try {
            ...
            int cid = DB.addClass(txtName.getText(), Integer.parseInt(txtSY.getText()), Integer.parseInt(txtSem.getText()), Integer.parseInt(txtYear.getText()), txtCourse.getText(), txtRoom.getText(), txtSched.getText(), cboLevel.getItemAt(cboLevel.getSelectedIndex()));
            caller.refresh();
