 ...
 * @author orthocube
 */
public class AddCriteriaSHS extends javax.swing.JFrame {
    int id, caps, cid;
    Criterias caller;
    
    /**
     * Creates new form AddCriteriaSHS
     */
    public AddCriteriaSHS(int i, int c, int ci, Criterias ca) {
        initComponents();
    ...
    private void cmdAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddActionPerformed
        ...
        try {
            ...
            if (chkFinals.isSelected())
                terms |= 2;
            DB.addCriteriaSHS(cid, txtName.getText(), Integer.parseInt(txtPercent.getText()), terms);
            caller.refresh();
            this.dispose();
        } catch (Exception ex) {
